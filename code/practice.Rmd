...
```{r}
print("Country","Mean GDP","Minimum GDP","Maximum GDP",sep="/t")
...
# TRENDS IN MARKDOWN TEXT
# Default & Small Bins - Globally the highest frequency of life expectancy is just over 70 years old. This trend becomes smoother when the bins are smaller.
